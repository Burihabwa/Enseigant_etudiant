...
<nav class="navbar navbar-expand-lg navbar-light" style="background:#E0FFFF">
    ...
    <div class="search-box">
        ...
        <table class="table table-hover border-secondary border mt-4" id="table">
                <thead>
                    <tr>
                    <th style="border: 1px solid" scope="col">Matricule</th>
                    <th scope="col">Nom</th>
                ...
                <?php
                    ...
                    while($row = mysqli_fetch_array($qrydisplay)){
                        ...
                        $nurero++;
                          ...
                          //  echo "$image";
	                    echo "<tr><td style='border: 1px solid' scope='row' ><strong>".$matricule."</strong></td><td>"
                        ...
                        <td><a href='supprimer.php?deleteid=$id' ><i class='fa fa-500px fas fa-user-times'></i></a></td></tr>";
                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-body">
                            <form id="#updateValues"  action="edit.php" method="POST" enctype="multipart/form-data" >
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="recipient-name" name="adresse" value = "<?php echo $adresse ?>">
                            </div>
                            <center class="mb-4">
                                <div style=""> 
