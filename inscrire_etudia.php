...
<nav class="navbar navbar-expand-lg navbar-light" style="background:#E0FFFF">
    ...
    <center>
      <h1 class="text-center mt-4 ">GRILLE D'INSCRIPTION AUX ENSEIGNANTS</h1>
        <div class="container mt-5
        ">
        <form class="row g-3 needs-validation" action="insert.php" method="POST"  novalidate enctype="multipart/form-data" >
  <div class="col-md-4">
    <label for="validationCustom01" class="form-label">Matricule</label>
    <input type="text" class="form-control" name="matricule" id="validationCustom01"  required>
    <div class="valid-feedback">
      Bien fait!
    </div>
    <div class="invalid-feedback">
      Veuiller entrer le Matricule
    </div>
  </div>
  <div class="col-md-4">
    <label for="validationCustom02" class="form-label">Nom</label>
    <input type="text" class="form-control" name="nom" id="validationCustom02"  required>
    <div class="valid-feedback">
      Bien fait!
    </div>
    <div class="invalid-feedback">
  ...
  <div class="col-md-4">
    <label for="validationCustom02" class="form-label"> Adressse</label>
    <input type="text" class="form-control" name="adresse" id="validationCustom02"  required>
    <div class="valid-feedback">
      Bien fait!
    </div>
    <div class="invalid-feedback">
      Veuiller entrer le Adresse
    </div>
  </div>
  <div class="col-md-4">
  ...
  <div class="row mt-4">
    <div class="d-grid gap-2 col-6 max-auto">
      ...
      <div class="d-grid gap-2 col-6 mx-auto">
        <a class="btn btn-outline-secondary" href="affichageEnsei.php">Verifier votre Enregistrement</a>
      </div>
  </div>
