...
<p class="text-center">
        <img src="imag/ugl.png" alt="logo" width="150" height="150">
    </p>
    <h1 class="text-center">Presentation de l'universite des grands lac U.G.L</h1>
    <marquee behavior="" direction="">
        <p>
            <img src="imag/ugl.jpeg" alt="ugl" height="300px">
            <img src="imag/ugl1.jpg" alt="ugl" height="300px">
        </p>
    </marquee>
...
<center>
  ...
  <input type="hidden" class="form-control" name="unive" id="validationCustom02" value="ugl"   required>
  ...
  <div class="row mt-4">
    <div class="d-grid gap-2 col-6 max-auto">
      ...
      <div class="d-grid gap-2 col-6 mx-auto">
        <a class="btn btn-outline-secondary" href="affichageEtud.php?unive=ugl">Verifier votre Enregistrement</a>
      </div>
  </div>
