  ...
  <a class="navbar-brand" href="index.php">
    ...
    <div class="list-group mt-5">
        <button type="button" class="list-group-item list-group-item-action active" aria-current="true">
            Les filieres disponible au rectrutement 
        </button>
        <a type="button" class="list-group-item list-group-item-action" href="concour.php">Mathémetique</a>
        <a type="button" class="list-group-item list-group-item-action" href="concourbio.php">Biologie</a>
        <a type="button" class="list-group-item list-group-item-action" href="concourbio.php">Informatique</a>
        <a type="button" class="list-group-item list-group-item-action" href="concourbio.php">Pysique</a>
        <a type="button" class="list-group-item list-group-item-action" href="concour.php">Chimie</a>
        </div>
    </center>
</div>
